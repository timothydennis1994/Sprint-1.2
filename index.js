...
1. Receive an array
2. Return a new array with names of artists who were born in and adied in 20th century (1900-2000) 
...
function addArtist(array){
    artists[20] = {id: 20, name: "Timothy Dennis", years: "1994-present", genre: "Web Design", nationality: "American-Italian-New Zealand(Kiwi", bio: "I am in the process of learning my future trade, web development. In fact, the information you are currently reading is part of my Sprint Challenge to test my understanding of the previous units foundations"};
    return array;
  }
